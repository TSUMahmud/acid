...
public interface ILineageWeatherManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILineageWeatherManager {
        private static final String DESCRIPTOR = "lineageos.weather.ILineageWeatherManager";
        ...
        static final int TRANSACTION_updateWeather = 1;

        public Stub() {
            attachInterface(this, DESCRIPTOR);
        }

        public static ILineageWeatherManager asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ILineageWeatherManager)) {
                return new Proxy(obj);
            }
            return (ILineageWeatherManager) iin;
        }
        ...
        private static class Proxy implements ILineageWeatherManager {
