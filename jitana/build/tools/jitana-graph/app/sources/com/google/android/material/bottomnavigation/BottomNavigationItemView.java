...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0581R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0581R.C0582drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C0581R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0581R.C0583id.icon);
        this.smallLabel = (TextView) findViewById(C0581R.C0583id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0581R.C0583id.largeLabel);
