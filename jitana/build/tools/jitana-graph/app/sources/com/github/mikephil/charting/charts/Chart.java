...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    public void onDraw(Canvas canvas) {
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.mNoDataText)) {
                ...
                canvas.drawText(this.mNoDataText, c.f90x, c.f91y, this.mInfoPaint);
            }
    ...
    public boolean saveToGallery(String fileName, String subFolderPath, String fileDescription, Bitmap.CompressFormat format, int quality) {
        ...
        int i = C05702.$SwitchMap$android$graphics$Bitmap$CompressFormat[format.ordinal()];
        if (i != 1) {
            if (i != 2) {
        ...
        try {
            ...
            try {
                ...
                values.put(ThemesContract.ThemesColumns.TITLE, mimeType2);
