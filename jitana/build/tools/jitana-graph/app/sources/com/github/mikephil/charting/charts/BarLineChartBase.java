...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    public void calculateLegendOffsets(RectF offsets) {
        ...
        if (this.mLegend != null && this.mLegend.isEnabled() && !this.mLegend.isDrawInsideEnabled()) {
            int i = C05682.f64x9c9dbef[this.mLegend.getOrientation().ordinal()];
            if (i == 1) {
                int i2 = C05682.f63x2787f53e[this.mLegend.getHorizontalAlignment().ordinal()];
                if (i2 == 1) {
                    ...
                    int i3 = C05682.f65xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                    if (i3 == 1) {
                ...
                int i4 = C05682.f65xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                if (i4 == 1) {
                    offsets.top += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
                } else if (i4 == 2) {
                    offsets.bottom += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
    ...
    static /* synthetic */ class C05682 {

        /* renamed from: $SwitchMap$com$github$mikephil$charting$components$Legend$LegendHorizontalAlignment */
        static final /* synthetic */ int[] f63x2787f53e = new int[Legend.LegendHorizontalAlignment.values().length];

        /* renamed from: $SwitchMap$com$github$mikephil$charting$components$Legend$LegendOrientation */
        static final /* synthetic */ int[] f64x9c9dbef = new int[Legend.LegendOrientation.values().length];

        /* renamed from: $SwitchMap$com$github$mikephil$charting$components$Legend$LegendVerticalAlignment */
        static final /* synthetic */ int[] f65xc926f1ec = new int[Legend.LegendVerticalAlignment.values().length];

        static {
            try {
                f64x9c9dbef[Legend.LegendOrientation.VERTICAL.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f64x9c9dbef[Legend.LegendOrientation.HORIZONTAL.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f63x2787f53e[Legend.LegendHorizontalAlignment.LEFT.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f63x2787f53e[Legend.LegendHorizontalAlignment.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f63x2787f53e[Legend.LegendHorizontalAlignment.CENTER.ordinal()] = 3;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f65xc926f1ec[Legend.LegendVerticalAlignment.TOP.ordinal()] = 1;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f65xc926f1ec[Legend.LegendVerticalAlignment.BOTTOM.ordinal()] = 2;
    ...
    public void zoomIn() {
        ...
        this.mViewPortHandler.zoomIn(center.f90x, -center.f91y, this.mZoomMatrixBuffer);
    ...
    public void zoomOut() {
        MPPointF center = this.mViewPortHandler.getContentCenter();
        this.mViewPortHandler.zoomOut(center.f90x, -center.f91y, this.mZoomMatrixBuffer);
        this.mViewPortHandler.refresh(this.mZoomMatrixBuffer, this, false);
        MPPointF.recycleInstance(center);
        calculateOffsets();
        postInvalidate();
    ...
    public void zoomToCenter(float scaleX, float scaleY) {
        ...
        this.mViewPortHandler.zoom(scaleX, scaleY, center.f90x, -center.f91y, save);
    ...
    public void zoomAndCenterAnimated(float scaleX, float scaleY, float xValue, float yValue, YAxis.AxisDependency axis, long duration) {
        ...
        addViewportJob(AnimatedZoomJob.getInstance(this.mViewPortHandler, this, getTransformer(axisDependency), getAxis(axisDependency), this.mXAxis.mAxisRange, scaleX, scaleY, this.mViewPortHandler.getScaleX(), this.mViewPortHandler.getScaleY(), xValue, yValue, (float) origin.f88x, (float) origin.f89y, duration));
    ...
    public void moveViewToAnimated(float xValue, float yValue, YAxis.AxisDependency axis, long duration) {
        ...
        float f = xValue;
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f, yValue + ((getAxisRange(axisDependency) / this.mViewPortHandler.getScaleY()) / 2.0f), getTransformer(axisDependency), this, (float) bounds.f88x, (float) bounds.f89y, duration));
    ...
    public void centerViewToAnimated(float xValue, float yValue, YAxis.AxisDependency axis, long duration) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, xValue - (xInView / 2.0f), yValue + (yInView / 2.0f), getTransformer(axisDependency), this, (float) bounds.f88x, (float) bounds.f89y, duration));
        MPPointD.recycleInstance(bounds);
    }
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f88x);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f88x);
    }
