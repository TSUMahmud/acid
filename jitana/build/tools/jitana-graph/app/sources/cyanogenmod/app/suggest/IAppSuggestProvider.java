...
public interface IAppSuggestProvider extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAppSuggestProvider {
        private static final String DESCRIPTOR = "cyanogenmod.app.suggest.IAppSuggestProvider";
        ...
        public static IAppSuggestProvider asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IAppSuggestProvider)) {
                return new Proxy(obj);
            }
            return (IAppSuggestProvider) iin;
        }
        ...
        private static class Proxy implements IAppSuggestProvider {
