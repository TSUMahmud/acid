...
public class SamePropertyValuesAs<T> extends TypeSafeDiagnosingMatcher<T> {
    ...
    public SamePropertyValuesAs(T expectedBean2) {
        PropertyDescriptor[] descriptors = PropertyUtil.propertyDescriptorsFor(expectedBean2, Object.class);
        this.expectedBean = expectedBean2;
        this.propertyNames = propertyNamesFrom(descriptors);
        this.propertyMatchers = propertyMatchersFor(expectedBean2, descriptors);
    }
    ...
    public static class PropertyMatcher extends DiagnosingMatcher<Object> {
        ...
        public boolean matches(Object actual, Description mismatch) {
            ...
            mismatch.appendText(this.propertyName + StringUtils.SPACE);
    ...
    @Factory
    public static <T> Matcher<T> samePropertyValuesAs(T expectedBean2) {
        return new SamePropertyValuesAs(expectedBean2);
    }
}
