...
public class MiBandActivitySample extends AbstractActivitySample implements Serializable {
    ...
    public MiBandActivitySample(int timestamp2, long deviceId2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
    }

    public MiBandActivitySample(int timestamp2, long deviceId2, long userId2, int rawIntensity2, int steps2, int rawKind2, int heartRate2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
        this.userId = userId2;
    ...
    public void __setDaoSession(DaoSession daoSession2) {
        ...
        this.myDao = daoSession2 != null ? daoSession2.getMiBandActivitySampleDao() : null;
    }
    ...
    public void delete() {
        MiBandActivitySampleDao miBandActivitySampleDao = this.myDao;
        if (miBandActivitySampleDao != null) {
            miBandActivitySampleDao.delete(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void update() {
        MiBandActivitySampleDao miBandActivitySampleDao = this.myDao;
        if (miBandActivitySampleDao != null) {
            miBandActivitySampleDao.update(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void refresh() {
        MiBandActivitySampleDao miBandActivitySampleDao = this.myDao;
        if (miBandActivitySampleDao != null) {
            miBandActivitySampleDao.refresh(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
