...
public class PebbleHealthActivitySampleDao extends AbstractDao<PebbleHealthActivitySample, Void> {
    ...
    public static class Properties {
        ...
        public static final Property RawIntensity = new Property(4, Integer.TYPE, "rawIntensity", false, "RAW_INTENSITY");
        public static final Property RawPebbleHealthData = new Property(3, byte[].class, "rawPebbleHealthData", false, "RAW_PEBBLE_HEALTH_DATA");
        public static final Property Steps = new Property(5, Integer.TYPE, MiBandConst.PREF_MI2_DISPLAY_ITEM_STEPS, false, "STEPS");
    ...
    public PebbleHealthActivitySampleDao(DaoConfig config, DaoSession daoSession2) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        sb.append("\"PEBBLE_HEALTH_ACTIVITY_SAMPLE\" (\"TIMESTAMP\" INTEGER  NOT NULL ,\"DEVICE_ID\" INTEGER  NOT NULL ,\"USER_ID\" INTEGER NOT NULL ,\"RAW_PEBBLE_HEALTH_DATA\" BLOB,\"RAW_INTENSITY\" INTEGER NOT NULL ,\"STEPS\" INTEGER NOT NULL ,\"HEART_RATE\" INTEGER NOT NULL ,PRIMARY KEY (\"TIMESTAMP\" ,\"DEVICE_ID\" ) ON CONFLICT REPLACE)");
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        ...
        sb.append("\"PEBBLE_HEALTH_ACTIVITY_SAMPLE\"");
        db.execSQL(sb.toString());
    }

    /* access modifiers changed from: protected */
    public void bindValues(SQLiteStatement stmt, PebbleHealthActivitySample entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(5, (long) entity.getRawIntensity());
        stmt.bindLong(6, (long) entity.getSteps());
        stmt.bindLong(7, (long) entity.getHeartRate());
    }

    /* access modifiers changed from: protected */
    public void attachEntity(PebbleHealthActivitySample entity) {
    ...
    public PebbleHealthActivitySample readEntity(Cursor cursor, int offset) {
        return new PebbleHealthActivitySample(cursor.getInt(offset + 0), cursor.getLong(offset + 1), cursor.getLong(offset + 2), cursor.isNull(offset + 3) ? null : cursor.getBlob(offset + 3), cursor.getInt(offset + 4), cursor.getInt(offset + 5), cursor.getInt(offset + 6));
    }
    ...
    /* access modifiers changed from: protected */
    public Void updateKeyAfterInsert(PebbleHealthActivitySample entity, long rowId) {
        return null;
    }
    ...
    /* access modifiers changed from: protected */
    public PebbleHealthActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        PebbleHealthActivitySample entity = (PebbleHealthActivitySample) loadCurrent(cursor, 0, lock);
    ...
    public PebbleHealthActivitySample loadDeep(Long key) {
        ...
        try {
            ...
            if (cursor.isLast()) {
                PebbleHealthActivitySample loadCurrentDeep = loadCurrentDeep(cursor, true);
                cursor.close();
    ...
    public List<PebbleHealthActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        ...
        List<PebbleHealthActivitySample> list = new ArrayList<>(count);
        if (cursor.moveToFirst()) {
    ...
    /* access modifiers changed from: protected */
    public List<PebbleHealthActivitySample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
