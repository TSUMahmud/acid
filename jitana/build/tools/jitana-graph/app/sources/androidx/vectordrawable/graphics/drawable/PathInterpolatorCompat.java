...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (numPoints > 0) {
            ...
            if (((double) Math.abs(this.f42mX[0])) > 1.0E-5d || ((double) Math.abs(this.f43mY[0])) > 1.0E-5d || ((double) Math.abs(this.f42mX[numPoints - 1] - 1.0f)) > 1.0E-5d || ((double) Math.abs(this.f43mY[numPoints - 1] - 1.0f)) > 1.0E-5d) {
