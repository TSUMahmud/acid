...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int padding = resources.getDimensionPixelSize(C0157R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0157R.dimen.notification_top_pad_large_text);
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                for (int i = this.mMessages.size() - 1; i >= 0; i--) {
                    ...
                    if (i != this.mMessages.size() - 1) {
                        completeMessage.insert(0, StringUtils.f210LF);
                    }
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            if (showActions && this.mBuilder.mActions != null && (numActions = Math.min(this.mBuilder.mActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    remoteViews.addView(C0157R.C0159id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (!actionsVisible) {
                actionVisibility = 8;
