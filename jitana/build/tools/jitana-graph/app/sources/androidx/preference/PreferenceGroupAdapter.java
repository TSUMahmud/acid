...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder> implements Preference.OnPreferenceChangeInternalListener, PreferenceGroup.PreferencePositionCallback {
    ...
    public PreferenceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TypedArray a = parent.getContext().obtainStyledAttributes((AttributeSet) null, C0361R.styleable.BackgroundStyle);
        Drawable background = a.getDrawable(C0361R.styleable.BackgroundStyle_android_selectableItemBackground);
        if (background == null) {
