    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (itemViewType == 0) {
                ...
                View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0039R.layout.abc_activity_chooser_view_list_item, parent, false);
                convertView2.setId(1);
                ((TextView) convertView2.findViewById(C0039R.C0041id.title)).setText(ActivityChooserView.this.getContext().getString(C0039R.string.abc_activity_chooser_view_see_all));
                return convertView2;
            }
        }
