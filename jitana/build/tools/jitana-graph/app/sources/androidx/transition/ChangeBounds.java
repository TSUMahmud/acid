    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (transitionValues == null) {
            ...
            if (startParent == null) {
                    ...
                    if (numChanges > 0) {
                        ...
                        if (!this.mResizeClip) {
                            ...
                            if (!startClip.equals(endClip)) {
                                ...
                                C04518 r0 = new AnimatorListenerAdapter() {
                                    ...
                                    public void onAnimationEnd(Animator animation) {
                                        if (!this.mIsCanceled) {
                                            ...
                                            ViewUtils.setLeftTopRightBottom(view6, i47, endWidth8, startHeight8, endTop2);
                                        }
                                    }
                                };
                ...
                C044410 r02 = new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animation) {
