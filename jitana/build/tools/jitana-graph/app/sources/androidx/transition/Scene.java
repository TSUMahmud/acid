...
public class Scene {
    ...
    public static Scene getSceneForLayout(ViewGroup sceneRoot, int layoutId, Context context) {
        SparseArray<Scene> scenes = (SparseArray) sceneRoot.getTag(C0468R.C0470id.transition_scene_layoutid_cache);
        if (scenes == null) {
            scenes = new SparseArray<>();
            sceneRoot.setTag(C0468R.C0470id.transition_scene_layoutid_cache, scenes);
        }
    ...
    static void setCurrentScene(View view, Scene scene) {
        view.setTag(C0468R.C0470id.transition_current_scene, scene);
    }

    static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(C0468R.C0470id.transition_current_scene);
    }
