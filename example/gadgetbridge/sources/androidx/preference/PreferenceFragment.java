...
public abstract class PreferenceFragment extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    private int mLayoutResId = C0361R.layout.preference_list_fragment;
    RecyclerView mList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().getTheme().resolveAttribute(C0361R.attr.preferenceTheme, tv, true);
        int theme = tv.resourceId;
        if (theme == 0) {
            theme = C0361R.style.PreferenceThemeOverlay;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        TypedArray a = this.mStyledContext.obtainStyledAttributes((AttributeSet) null, C0361R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(this.mStyledContext, C0361R.attr.preferenceFragmentStyle, 16844038), 0);
        this.mLayoutResId = a.getResourceId(C0361R.styleable.PreferenceFragment_android_layout, this.mLayoutResId);
        Drawable divider = a.getDrawable(C0361R.styleable.PreferenceFragment_android_divider);
        int dividerHeight = a.getDimensionPixelSize(C0361R.styleable.PreferenceFragment_android_dividerHeight, -1);
        boolean allowDividerAfterLastItem = a.getBoolean(C0361R.styleable.PreferenceFragment_allowDividerAfterLastItem, true);
        a.recycle();
    ...
    public RecyclerView onCreateRecyclerView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        if (this.mStyledContext.getPackageManager().hasSystemFeature("android.hardware.type.automotive") && (recyclerView = (RecyclerView) parent.findViewById(C0361R.C0363id.recycler_view)) != null) {
            return recyclerView;
        }
        RecyclerView recyclerView2 = (RecyclerView) inflater.inflate(C0361R.layout.preference_recyclerview, parent, false);
