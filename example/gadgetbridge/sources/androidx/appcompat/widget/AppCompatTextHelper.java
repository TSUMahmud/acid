...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (ap != -1) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && a2.hasValue(C0039R.styleable.TextAppearance_fontVariationSettings)) {
        ...
        int i2 = ap;
        if (Build.VERSION.SDK_INT >= 26 && a3.hasValue(C0039R.styleable.TextAppearance_fontVariationSettings)) {
        ...
        if (a4.hasValue(C0039R.styleable.AppCompatTextView_drawableTintMode)) {
            TextViewCompat.setCompoundDrawableTintMode(this.mView, DrawableUtils.parseTintMode(a4.getInt(C0039R.styleable.AppCompatTextView_drawableTintMode, -1), (PorterDuff.Mode) null));
        }
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        } else if (a.hasValue(C0039R.styleable.TextAppearance_android_typeface)) {
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        if (Build.VERSION.SDK_INT < 23 && a.hasValue(C0039R.styleable.TextAppearance_android_textColor) && (textColor = a.getColorStateList(C0039R.styleable.TextAppearance_android_textColor)) != null) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && a.hasValue(C0039R.styleable.TextAppearance_fontVariationSettings) && (fontVariation = a.getString(C0039R.styleable.TextAppearance_fontVariationSettings)) != null) {
            this.mView.setFontVariationSettings(fontVariation);
        }
        a.recycle();
        Typeface typeface = this.mFontTypeface;
