...
public class MakibesHR3ActivitySample extends AbstractActivitySample implements Serializable {
    ...
    public MakibesHR3ActivitySample(int timestamp2, long deviceId2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
    }

    public MakibesHR3ActivitySample(int timestamp2, long deviceId2, long userId2, int steps2, int rawKind2, int heartRate2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
        this.userId = userId2;
        this.steps = steps2;
    ...
    public void __setDaoSession(DaoSession daoSession2) {
        ...
        this.myDao = daoSession2 != null ? daoSession2.getMakibesHR3ActivitySampleDao() : null;
    }
    ...
    public void delete() {
        MakibesHR3ActivitySampleDao makibesHR3ActivitySampleDao = this.myDao;
        if (makibesHR3ActivitySampleDao != null) {
            makibesHR3ActivitySampleDao.delete(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void update() {
        MakibesHR3ActivitySampleDao makibesHR3ActivitySampleDao = this.myDao;
        if (makibesHR3ActivitySampleDao != null) {
            makibesHR3ActivitySampleDao.update(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void refresh() {
        MakibesHR3ActivitySampleDao makibesHR3ActivitySampleDao = this.myDao;
        if (makibesHR3ActivitySampleDao != null) {
            makibesHR3ActivitySampleDao.refresh(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
