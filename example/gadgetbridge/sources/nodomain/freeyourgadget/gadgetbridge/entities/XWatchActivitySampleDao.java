...
public class XWatchActivitySampleDao extends AbstractDao<XWatchActivitySample, Void> {
    ...
    public XWatchActivitySampleDao(DaoConfig config, DaoSession daoSession2) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        sb.append("\"XWATCH_ACTIVITY_SAMPLE\" (\"TIMESTAMP\" INTEGER  NOT NULL ,\"DEVICE_ID\" INTEGER  NOT NULL ,\"USER_ID\" INTEGER NOT NULL ,\"STEPS\" INTEGER NOT NULL ,\"RAW_KIND\" INTEGER NOT NULL ,\"RAW_INTENSITY\" INTEGER NOT NULL ,\"HEART_RATE\" INTEGER NOT NULL ,PRIMARY KEY (\"TIMESTAMP\" ,\"DEVICE_ID\" ) ON CONFLICT REPLACE)");
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        ...
        sb.append("\"XWATCH_ACTIVITY_SAMPLE\"");
        db.execSQL(sb.toString());
    }

    /* access modifiers changed from: protected */
    public void bindValues(SQLiteStatement stmt, XWatchActivitySample entity) {
        stmt.clearBindings();
    ...
    /* access modifiers changed from: protected */
    public void attachEntity(XWatchActivitySample entity) {
    ...
    public XWatchActivitySample readEntity(Cursor cursor, int offset) {
        return new XWatchActivitySample(cursor.getInt(offset + 0), cursor.getLong(offset + 1), cursor.getLong(offset + 2), cursor.getInt(offset + 3), cursor.getInt(offset + 4), cursor.getInt(offset + 5), cursor.getInt(offset + 6));
    }
    ...
    /* access modifiers changed from: protected */
    public Void updateKeyAfterInsert(XWatchActivitySample entity, long rowId) {
        return null;
    }
    ...
    /* access modifiers changed from: protected */
    public XWatchActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        XWatchActivitySample entity = (XWatchActivitySample) loadCurrent(cursor, 0, lock);
    ...
    public XWatchActivitySample loadDeep(Long key) {
        ...
        try {
            ...
            if (cursor.isLast()) {
                XWatchActivitySample loadCurrentDeep = loadCurrentDeep(cursor, true);
                cursor.close();
    ...
    public List<XWatchActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        ...
        List<XWatchActivitySample> list = new ArrayList<>(count);
        if (cursor.moveToFirst()) {
    ...
    /* access modifiers changed from: protected */
    public List<XWatchActivitySample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
