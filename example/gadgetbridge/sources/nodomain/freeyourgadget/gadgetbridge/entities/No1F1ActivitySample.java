...
public class No1F1ActivitySample extends AbstractActivitySample implements Serializable {
    ...
    public No1F1ActivitySample(int timestamp2, long deviceId2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
    }

    public No1F1ActivitySample(int timestamp2, long deviceId2, long userId2, int steps2, int rawKind2, int rawIntensity2, int heartRate2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
        this.userId = userId2;
        this.steps = steps2;
    ...
    public void __setDaoSession(DaoSession daoSession2) {
        ...
        this.myDao = daoSession2 != null ? daoSession2.getNo1F1ActivitySampleDao() : null;
    }
    ...
    public void delete() {
        No1F1ActivitySampleDao no1F1ActivitySampleDao = this.myDao;
        if (no1F1ActivitySampleDao != null) {
            no1F1ActivitySampleDao.delete(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void update() {
        No1F1ActivitySampleDao no1F1ActivitySampleDao = this.myDao;
        if (no1F1ActivitySampleDao != null) {
            no1F1ActivitySampleDao.update(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void refresh() {
        No1F1ActivitySampleDao no1F1ActivitySampleDao = this.myDao;
        if (no1F1ActivitySampleDao != null) {
            no1F1ActivitySampleDao.refresh(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
