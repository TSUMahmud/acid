...
public class PebbleMorpheuzSample extends AbstractPebbleMorpheuzActivitySample {
    ...
    public PebbleMorpheuzSample(int timestamp2, long deviceId2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
    }

    public PebbleMorpheuzSample(int timestamp2, long deviceId2, long userId2, int rawIntensity2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
        this.userId = userId2;
    ...
    public void __setDaoSession(DaoSession daoSession2) {
        ...
        this.myDao = daoSession2 != null ? daoSession2.getPebbleMorpheuzSampleDao() : null;
    }
    ...
    public void delete() {
        PebbleMorpheuzSampleDao pebbleMorpheuzSampleDao = this.myDao;
        if (pebbleMorpheuzSampleDao != null) {
            pebbleMorpheuzSampleDao.delete(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void update() {
        PebbleMorpheuzSampleDao pebbleMorpheuzSampleDao = this.myDao;
        if (pebbleMorpheuzSampleDao != null) {
            pebbleMorpheuzSampleDao.update(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void refresh() {
        PebbleMorpheuzSampleDao pebbleMorpheuzSampleDao = this.myDao;
        if (pebbleMorpheuzSampleDao != null) {
            pebbleMorpheuzSampleDao.refresh(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
