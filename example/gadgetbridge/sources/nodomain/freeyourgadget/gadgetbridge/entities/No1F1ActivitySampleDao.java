...
public class No1F1ActivitySampleDao extends AbstractDao<No1F1ActivitySample, Void> {
    ...
    public No1F1ActivitySampleDao(DaoConfig config, DaoSession daoSession2) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        sb.append("\"NO1_F1_ACTIVITY_SAMPLE\" (\"TIMESTAMP\" INTEGER  NOT NULL ,\"DEVICE_ID\" INTEGER  NOT NULL ,\"USER_ID\" INTEGER NOT NULL ,\"STEPS\" INTEGER NOT NULL ,\"RAW_KIND\" INTEGER NOT NULL ,\"RAW_INTENSITY\" INTEGER NOT NULL ,\"HEART_RATE\" INTEGER NOT NULL ,PRIMARY KEY (\"TIMESTAMP\" ,\"DEVICE_ID\" ) ON CONFLICT REPLACE)");
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        ...
        sb.append("\"NO1_F1_ACTIVITY_SAMPLE\"");
        db.execSQL(sb.toString());
    }

    /* access modifiers changed from: protected */
    public void bindValues(SQLiteStatement stmt, No1F1ActivitySample entity) {
        stmt.clearBindings();
    ...
    /* access modifiers changed from: protected */
    public void attachEntity(No1F1ActivitySample entity) {
    ...
    public No1F1ActivitySample readEntity(Cursor cursor, int offset) {
        return new No1F1ActivitySample(cursor.getInt(offset + 0), cursor.getLong(offset + 1), cursor.getLong(offset + 2), cursor.getInt(offset + 3), cursor.getInt(offset + 4), cursor.getInt(offset + 5), cursor.getInt(offset + 6));
    }
    ...
    /* access modifiers changed from: protected */
    public Void updateKeyAfterInsert(No1F1ActivitySample entity, long rowId) {
        return null;
    }
    ...
    /* access modifiers changed from: protected */
    public No1F1ActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        No1F1ActivitySample entity = (No1F1ActivitySample) loadCurrent(cursor, 0, lock);
    ...
    public No1F1ActivitySample loadDeep(Long key) {
        ...
        try {
            ...
            if (cursor.isLast()) {
                No1F1ActivitySample loadCurrentDeep = loadCurrentDeep(cursor, true);
                cursor.close();
    ...
    public List<No1F1ActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        ...
        List<No1F1ActivitySample> list = new ArrayList<>(count);
        if (cursor.moveToFirst()) {
    ...
    /* access modifiers changed from: protected */
    public List<No1F1ActivitySample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
