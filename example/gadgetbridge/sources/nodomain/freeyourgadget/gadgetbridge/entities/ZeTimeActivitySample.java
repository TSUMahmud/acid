...
public class ZeTimeActivitySample extends AbstractActivitySample implements Serializable {
    ...
    public ZeTimeActivitySample(int timestamp2, long deviceId2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
    }

    public ZeTimeActivitySample(int timestamp2, long deviceId2, long userId2, int steps2, int rawKind2, int rawIntensity2, int heartRate2, Integer caloriesBurnt2, Integer distanceMeters2, Integer activeTimeMinutes2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
        this.userId = userId2;
        this.steps = steps2;
    ...
    public void __setDaoSession(DaoSession daoSession2) {
        ...
        this.myDao = daoSession2 != null ? daoSession2.getZeTimeActivitySampleDao() : null;
    }
    ...
    public void delete() {
        ZeTimeActivitySampleDao zeTimeActivitySampleDao = this.myDao;
        if (zeTimeActivitySampleDao != null) {
            zeTimeActivitySampleDao.delete(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void update() {
        ZeTimeActivitySampleDao zeTimeActivitySampleDao = this.myDao;
        if (zeTimeActivitySampleDao != null) {
            zeTimeActivitySampleDao.update(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void refresh() {
        ZeTimeActivitySampleDao zeTimeActivitySampleDao = this.myDao;
        if (zeTimeActivitySampleDao != null) {
            zeTimeActivitySampleDao.refresh(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
