...
public class ID115ActivitySample extends AbstractActivitySample implements Serializable {
    ...
    public ID115ActivitySample(int timestamp2, long deviceId2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
    }

    public ID115ActivitySample(int timestamp2, long deviceId2, long userId2, int steps2, int rawKind2, Integer caloriesBurnt2, Integer distanceMeters2, Integer activeTimeMinutes2) {
        this.timestamp = timestamp2;
        this.deviceId = deviceId2;
        this.userId = userId2;
        this.steps = steps2;
    ...
    public void __setDaoSession(DaoSession daoSession2) {
        ...
        this.myDao = daoSession2 != null ? daoSession2.getID115ActivitySampleDao() : null;
    }
    ...
    public void delete() {
        ID115ActivitySampleDao iD115ActivitySampleDao = this.myDao;
        if (iD115ActivitySampleDao != null) {
            iD115ActivitySampleDao.delete(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void update() {
        ID115ActivitySampleDao iD115ActivitySampleDao = this.myDao;
        if (iD115ActivitySampleDao != null) {
            iD115ActivitySampleDao.update(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
    ...
    public void refresh() {
        ID115ActivitySampleDao iD115ActivitySampleDao = this.myDao;
        if (iD115ActivitySampleDao != null) {
            iD115ActivitySampleDao.refresh(this);
            return;
        }
        throw new DaoException("Entity is detached from DAO context");
    }
