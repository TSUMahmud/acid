...
public class IsArrayContaining<T> extends TypeSafeMatcher<T[]> {
    ...
    public IsArrayContaining(Matcher<? super T> elementMatcher2) {
    ...
    @Factory
    public static <T> Matcher<T[]> hasItemInArray(Matcher<? super T> elementMatcher2) {
        return new IsArrayContaining(elementMatcher2);
    }
