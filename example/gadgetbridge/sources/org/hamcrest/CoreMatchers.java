...
import org.hamcrest.core.C1304Is;
...
public class CoreMatchers {
    ...
    /* renamed from: is */
    public static <T> Matcher<T> m54is(T value) {
        return C1304Is.m62is(value);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m55is(Matcher<T> matcher) {
        return C1304Is.m63is(matcher);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m53is(Class<T> type) {
        return C1304Is.m61is(type);
    }

    public static <T> Matcher<T> isA(Class<T> type) {
        return C1304Is.isA(type);
    }
