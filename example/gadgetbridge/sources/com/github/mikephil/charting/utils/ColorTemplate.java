...
public class ColorTemplate {
    ...
    public static final int[] LIBERTY_COLORS = {Color.rgb(207, 248, 246), Color.rgb(148, 212, 212), Color.rgb(SyslogConstants.LOG_LOCAL1, 180, 187), Color.rgb(118, 174, ActivityUser.defaultUserHeightCm), Color.rgb(42, 109, 130)};
    public static final int[] MATERIAL_COLORS = {rgb("#2ecc71"), rgb("#f1c40f"), rgb("#e74c3c"), rgb("#3498db")};
    public static final int[] PASTEL_COLORS = {Color.rgb(64, 89, 128), Color.rgb(149, BuildConfig.VERSION_CODE, 124), Color.rgb(217, SyslogConstants.LOG_LOCAL7, 162), Color.rgb(191, 134, 134), Color.rgb(179, 48, 80)};
