...
final class IndicatorViewController {
    ...
    private final float captionTranslationYPx = ((float) this.context.getResources().getDimensionPixelSize(C0581R.dimen.design_textinput_caption_translate_y));
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.errorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.errorView.setId(C0581R.C0583id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean enabled) {
        if (this.helperTextEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.helperTextView.setId(C0581R.C0583id.textinput_helper_text);
                Typeface typeface2 = this.typeface;
                if (typeface2 != null) {
